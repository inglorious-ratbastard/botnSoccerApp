...
public class standingController {
    ...
    public standingController(DataCacheService dataService) {
    ...
    public String showStandings(Model model) {
        ...
        if (cache == null) cache = Collections.emptyMap();
        
        Map<String, Object> standings = new HashMap<>();
        if (cache.get("standings") instanceof Map) {
            standings = (Map<String, Object>) cache.get("standings");
        }

        model.addAttribute("worldCupGroups",
                standings.getOrDefault("worldCupGroups", Collections.emptyMap()));
        model.addAttribute("championsLeagueGroups",
                standings.getOrDefault("championsLeagueGroups", Collections.emptyMap()));
        model.addAttribute("euroGroups",
                standings.getOrDefault("euroGroups", Collections.emptyMap()));
